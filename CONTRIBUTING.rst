...
pureyaml could always use more documentation, whether as part of the
official pureyaml docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
1. Fork the `pureyaml` repo on GitHub.
...
2. If the pull request adds functionality, the docs should be updated. Put
   ...
   feature to the list in README-orig.rst.
3. The pull request should work for Python 2.6, 2.7, 3.3, 3.4, 3.5, and PyPy. Check
   https://travis-ci.org/bionikspoon/pureyaml/pull_requests
...
.. code-block:: shell
    ...
    $ py.test tests/test_pureyaml.py
